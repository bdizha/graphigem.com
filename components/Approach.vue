<template>
  <v-card rounded="0" theme="darkGrey" class="p12" min-height="900px">
          ...
          <v-row align="center" justify="center">
            <v-col lg="6" cols="12">
              ...
              <NuxtLink to="/#contact-us">
                <v-btn size="x-large" color="secondary" class="mx-1 my-3" rounded="xl">
                  Get started
                </v-btn>
              </NuxtLink>
            </v-col>
            <v-col lg="12" cols="12">
              <v-row justify="start">
                <v-col lg="3" cols="12" v-for="(step, index) in steps" :key="index">
                  <v-card :theme="step.theme" rounded="xl" class="p0">
                    <v-card :theme="step.accent" rounded="xl" class="p3" min-height="300">
